...
void oled_seneor_flag(){
	...
	OLED_ShowChar(18, 16, l, 16,1);
	OLED_ShowChinese(70, 16, 0, 16, 1);
	OLED_ShowChar(0, 32, n, 16, 1);
	OLED_ShowChar(18, 32, l, 16,1);
	OLED_ShowChar( 70, 32 , j, 16, 1);
	OLED_ShowChar(80 , 32 , m, 16, 1);
	OLED_ShowChar(88 , 32 , n, 16, 1);
}
